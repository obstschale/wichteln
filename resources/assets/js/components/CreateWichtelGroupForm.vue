<template>
    <div>
        ...
        <div v-show="! isSubmitted" class="section columns">
            <div class="column">
                <div class="field">
        ...
        <button v-show="! isSubmitted" class="button is-link" @click="submit" :disabled="isSubmitted">Neue Wichtel Aktion starten</button>
    </div>
</template>
